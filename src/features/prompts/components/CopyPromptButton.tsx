...
export function CopyPromptButton({
  ...
  return (
    <button
      ...
      className={`flex h-control-lg w-control-lg shrink-0 items-center justify-center rounded-md transition-[transform,color,background-color] hover:bg-accent hover:text-foreground active:scale-[0.96] disabled:pointer-events-none disabled:opacity-50 ${
