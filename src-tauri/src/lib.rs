...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::prompt::prompt_duplicate,
            commands::prompt::prompt_batch_move,
            ...
            commands::evaluation::profile_list,
            commands::evaluation::profile_save,
            commands::evaluation::render,
            commands::evaluation::run,
            commands::evaluation::run_list,
            commands::evaluation::run_get,
            commands::evaluation::cancel,
            commands::evaluation::test_set_list,
            commands::evaluation::test_set_save,
            commands::evaluation::test_set_export,
            commands::evaluation::test_set_import,
            commands::evaluation::evaluator_list,
            commands::evaluation::evaluator_create,
            commands::evaluation::matrix_run,
            commands::evaluation::matrix_retry,
            commands::evaluation::matrix_list,
            commands::evaluation::matrix_get,
            commands::evaluation::manual_result,
            commands::evaluation::label_list,
            commands::evaluation::label_move,
            commands::evaluation::label_rollback,
            commands::evaluation::label_history,
